...
from models.optim import Ranger
    ...
    def from_dataset(
        ...
        new_kwargs = dict(
            ...
            time_varying_categoricals_encoder=[
                                                  name for name in dataset.time_varying_known_categoricals if
                                                  name in allowed_encoder_known_variable_names
                                              ]
            ...
            time_varying_reals_encoder=[
                                           name for name in dataset.time_varying_known_reals if
                                           name in allowed_encoder_known_variable_names
                                       ]
            ...
            extra_decoder=dataset.extra_decoder
        )
